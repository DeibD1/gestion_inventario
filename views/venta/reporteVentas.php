...
<div class="container">
    ...
    <div>
        <h4 class="titulo mb-3"><?= $data['titulo'] ?></h4>
        <form method="post" action="index.php?controlador=Venta&accion=#" class="row g-3 align-items-end">
            <div class="col-md-2">
    ...
    <h1 class="titulo my-5">VENTAS</h1>
